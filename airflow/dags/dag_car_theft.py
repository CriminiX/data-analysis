...
import os
from models.setup_car_threft import start_setup_car_threft
...
with DAG(
    "ssp_extraction_to_s3_car_theft", schedule="@monthly", catchup=True, max_active_runs=2, default_args=default_args
) as dag:
    filename = "{{ ds }}.xlsx"
    execution_date = "{{ ds }}"
